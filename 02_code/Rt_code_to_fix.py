...
Path(path_output+now).mkdir(parents=True, exist_ok=True)
...
original, smoothed = prepare_cases(adjusted)
...
posteriors, log_likelihood = get_posteriors(smoothed, sigma=.30)
